...
EDA tab - Exploratory Data Analysis (EDA) allows business users to explore the data using different variables and aggregation levels, keeping in mind visualization best practices. This tab is further segmented into the various charts:
...
The half eye plot was used to visualize distribution. Half Eye plots combine densities with intervals to give a more detailed picture of uncertainty than is available just by looking at intervals.

The ggdist package was used to visualize distributions.
