...
singaporedata$endtime <-  as.Date(singaporedata$endtime, format = "%d/%m/%Y %H:%M")
...
#singaporedata_cleaned = subset(singaporedata_cleaned, select = -c(i14_health_other,w4b,m7_other) )
...
singaporedata_cleaned <- singaporedata_cleaned %>%
    ...
    mutate(Willing_to_vacc_immed = case_when(
        ...
        Willing_to_vacc_immed == "5 - Strongly disagree" ~ "Strongly Disagree",
    ...
    mutate(Worried_about_Covid = case_when(
        ...
        Worried_about_Covid == "5 - Strongly disagree" ~ "Strongly Disagree",
    ...
    mutate(Worried_about_side_effects_vacc = case_when(
        ...
        Worried_about_side_effects_vacc == "5 - Strongly disagree" ~ "Strongly Disagree",
    ...
    mutate(Belief_in_Govt = case_when(
        ...
        Belief_in_Govt == "5 - Strongly disagree" ~ "Strongly Disagree",
    ...
    mutate(Belief_vacc_protect_Covid_effects = case_when(
        ...
        Belief_vacc_protect_Covid_effects == "5 - Strongly disagree" ~ "Strongly Disagree",
    ...
    mutate(Belief_vacc_prevent_transmission = case_when(
        ...
        Belief_vacc_prevent_transmission == "5 - Strongly disagree" ~ "Strongly Disagree",
...
server <- function(input, output, session) {
    ...
    output$dist <- renderPlot({
        ...
        singaporedata_cleaned[singaporedata_cleaned == "5 - Strongly disagree"] <- 5
